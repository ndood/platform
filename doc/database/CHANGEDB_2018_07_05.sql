...
ALTER TABLE `t_pilot_order` ADD COLUMN `admin_name` varchar(256) DEFAULT NULL COMMENT '管理员名称' after `factor`;
ALTER TABLE `t_pilot_order` ADD COLUMN `admin_id` int(11) DEFAULT NULL COMMENT '管理员ID' after `factor`;
