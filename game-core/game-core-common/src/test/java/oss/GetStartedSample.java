...
public class GetStartedSample {
    ...
    private static String key = "lalala";
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            ObjectListing objectListing = ossClient.listObjects(bucketName, "test");
    ...
    private static File createSampleFile() throws IOException {
        File file = File.createTempFile("wangbin-test", ".txt");
        file.deleteOnExit();

        Writer writer = new OutputStreamWriter(new FileOutputStream(file));
        writer.write("abcdefghijklmnopqrstuvwxyz\n");
        writer.write("0123456789011234asdasd567890\n");
        writer.write("01234567890112345sad67890\n");
        writer.close();
