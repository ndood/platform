...
public class UserAutoReceiveOrder implements Serializable {
    ...
    //用户自己自动接单设置
    @Excel(name = "自动接单设置", orderNum = "1", width = 15)
    ...
    //自动派单完成数
    @Excel(name = "上分订单完成数", orderNum = "8", width = 15)
    private Integer orderCompleteNum;
    //派单取消数
    @Excel(name = "上分订单取消数", orderNum = "9", width = 15)
    private Integer orderCancelNum;
    //派单协商仲裁数
    @Excel(name = "上分订单协商仲裁数", orderNum = "10", width = 15)
